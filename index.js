...
const person = makePersonObject(5, "Leia", "leia@leia.com");
console.log(person);
...
const personName = getName(1, 'Leia', "leia@leia.com");

console.log('Hello, my name is ' + personName.name + '.');
...
function isItAnApple(a) {
  for (let i = 0; i <a.length; i++){
    if (a [i] === 'apple'){
      fruitResult.push(true);
    } else {
      fruitResult.push(false);
    } 
...
function getLastCarInfo(array) {
  const vehical = array[array.length-1];
  return `This is a ${vehical.car_make} ${vehical.car_model}.`
}

console.log(getLastCarInfo(inventory2))
/**
...
const carYears =[]
console.log(getModelYears(inventory2))
